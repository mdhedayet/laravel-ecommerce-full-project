                ...
                <div class="img-select">
                    <div class="img-item">
                        <a href="#" data-id="1">
                            ...
                            @endif
                            @if (!empty($productDetails['main_image']) && file_exists($product_iamge_path))
                            <img style="height: 85px !important; width:85px !important;"
                                src="{{url('images/product_images/small/'.$productDetails['main_image'])}}" alt="" />
                            @else
                            <img style="height: 85px !important; width:85px !important;"
                                src="{{url('images/product_images/small/no-image.jpg')}}" alt="" />
                            @endif
                        </a>
                    </div>
                    ...
                    <div class="img-item">
                        <a href="#" data-id="{{$key+2}}">
                            <img style="height: 85px !important; width:85px !important;"
                                src="{{url('images/product_images/small/'.$image['image'])}}" alt="shoe image">
                        </a>
                    </div>
                    @endforeach
                </div>
        ...
        <form action="{{url('/add-to-cart')}}" method="POST">
            ...
            <div class="col-sm-7">
                <div class="product-information">
                    ...
                    <input type="hidden" name="page" value="product_detail_page">
                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <a href="{{url('product/'.$item['id'])}}">
                                        ...
                                        <img src="{{url('images/product_images/medium/'.$item['main_image'])}}"
                                            alt="" />
                                        @else
                                        <img src="{{url('images/product_images/medium/no-image.jpg')}}" alt="" />
                                        @endif
                            ...
                            <div class="choose">
                                <ul class="nav nav-pills nav-justified">
                                    <li><a href="{{url('product/'.$item['id'])}}"><i class="fa fa-eye"></i>View
                                            Details</a></li>
