    ...
    <div class="all_category_items">
        ...
        <div style="margin-bottom: 30px !important;" class="form-inline col-sm-12">
            ...
            {{-- <a href="{{url('/')}}">Home</a><span
                class="devider">/</span><?php echo $CategoryDetails['breadcrumbs'];?> --}}
            <form name="sortProducts" id="sortProducts" style="display:inline; float:right;">
                ...
                <select name="sort" id="sort" class="form-control">
                    ...
                    <option value="product_highest" @if(isset($_GET['sort']) && $_GET['sort']=='product_highest' )
                        selected @endif>Highest Price First</option>
                </select>
            </form>
        </div>
